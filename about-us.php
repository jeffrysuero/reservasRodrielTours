...
<body>
  ...
  <!-- Page-->
  <div class="page"><a class="section section-banner text-center d-none d-xl-block"></a>
    <!-- Page Header-->
      ...
      <div class="container container-bigger">
        <div class="row row-50 justify-content-md-center align-items-lg-center justify-content-xl-between flex-lg-row-reverse">
          <div class="col-md-10 col-lg-6 col-xl-5">
            <h3>Bienvenidos a Rodriel Tours – Transporte Turístico</h3>
            ...
            <h2 class="title title_color">Nuestra Mision</h2>
            <p>Nuestra misión es proporcionar un servicio de transporte turístico de alta calidad que no solo cumpla sino que supere las expectativas de nuestros clientes. Creemos en la importancia de ofrecer un trato amable y personalizado, asegurándonos de que cada cliente se sienta valorado y atendido.</p>
            <h2 class="title title_color">Por Quė Elegirnos</h2>
            <p>
              Seguridad y Confiabilidad: Nuestros vehículos pasan por rigurosos controles de calidad y mantenimiento para asegurar tu seguridad en cada viaje.
              Comodidad: Ofrecemos una experiencia de viaje cómoda y sin estrés, con asientos espaciosos y amenidades modernas.
              Conocimiento Local: Nuestros conductores no solo te llevarán a tu destino, sino que también te ofrecerán información y consejos útiles sobre los mejores lugares para visitar.
              Flexibilidad: Adaptamos nuestros servicios a tus necesidades, ofreciendo paquetes personalizados y horarios flexibles.
              Descubre con Nosotros

              En Rodriel Tours, cada viaje es una oportunidad para descubrir algo nuevo y emocionante. Ya sea que estés buscando una escapada relajante en la playa, una aventura en la montaña, o un recorrido cultural por la ciudad, estamos aquí para hacer que tu experiencia sea inolvidable.

              ¡Únete a nosotros y descubre el mundo con Rodriel Tours!</p>
          </div>
          <div class="col-md-10 col-lg-6"><img src="images/about_bg1.png" alt="" width="720" height="459" />
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row row-50 row-xxl-90 justify-content-sm-center offset-custom-2">
          <div class="col-md-6 col-lg-3">
            <div class="team-classic team-classic-circle">
              <figure><img class="rounded-circle" src="images/andy.png" alt="" width="300" height="300" />
              </figure>
      ...
      <div class="container container-bigger">
        <div class="row row-fix row-50 justify-content-sm-center justify-content-xl-between">
          <div class="col-sm-10 col-md-12 col-xl-7">
            <h3>CRONOGRAMA DE LA AGENCIA</h3>
            <div class="divider divider-decorate"></div>
            ...
            <div class="time-line-vertical inset-md">
                ...
                <div class="unit unit-sm flex-column flex-md-row unit-spacing-xxl">
                  <div class="unit-left">
                    <div class="time-line-time">
                      <time class="wow fadeInLeft" data-wow-delay=".0s" datetime="2018">2015 - Fundación de Rodriel Tours</time>
                    </div>
                  </div>
                  <div class="unit-body">
              ...
              <div class="time-line-vertical-element">
                <div class="unit flex-column flex-md-row unit-spacing-xxl">
                  <div class="unit-left">
                    <div class="time-line-time">
                      <time class="wow fadeInLeft" data-wow-delay=".1s" datetime="2018">2022 - Expansión Regional</time>
                    </div>
                  </div>
                  <div class="unit-body">
              ...
              <div class="time-line-vertical-element">
                <div class="unit flex-column flex-md-row unit-spacing-xxl">
                  <div class="unit-left">
                    <div class="time-line-time">
                      <time class="wow fadeInLeft" data-wow-delay=".2s" datetime="2018">2024 - Futuro Brillante</time>
                    </div>
                  </div>
                  <div class="unit-body">
      ...
      <div class="container container-wide">
        <div class="row row-fix row-50 justify-content-md-center">
          <div class="col-sm-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
            ...
            <div class="divider divider-decorate"></div>
            <p>
            Explora los Principales Destinos con Rodriel Tours
Rodriel Tours se enorgullece de ofrecer servicios de transporte de alta calidad a una amplia variedad de destinos, asegurando que cada viaje sea cómodo, seguro y puntual. A continuación, te presentamos algunos de nuestros destinos más populares:
            </p>
          </div>
        </div>
        <div class="row row-50" data-lightgallery="group">
          <div class="col-sm-12 col-md-6 col-lg-4"><a class="gallery-item titled-gallery-item" href="images/project-1-1200x800-original.jpg" data-lightgallery="item">
            ...
            <div class="titled-gallery-caption"><a href="#">Aeropuerto Internacional de Santo Domingo (Las Américas)</a></div>
          </div>
          <div class="col-sm-12 col-md-6 col-lg-4"><a class="gallery-item titled-gallery-item" href="images/project-2-1200x800-original.jpg" data-lightgallery="item">
            ...
            <div class="titled-gallery-caption"><a href="#">Punta Cana</a></div>
          </div>
          <div class="col-sm-12 col-md-6 col-lg-4"><a class="gallery-item titled-gallery-item" href="images/project-3-1200x800-original.jpg" data-lightgallery="item">
            ...
            <div class="titled-gallery-caption"><a href="#">Samaná</a></div>
          </div>
          <div class="col-sm-12 col-md-6 col-lg-4"><a class="gallery-item titled-gallery-item" href="images/project-4-1200x800-original.jpg" data-lightgallery="item">
            ...
            <div class="titled-gallery-caption"><a href="#">Bayahibe</a></div>
          </div>
          <div class="col-sm-12 col-md-6 col-lg-4"><a class="gallery-item titled-gallery-item" href="images/project-5-1200x800-original.jpg" data-lightgallery="item">
            ...
            <div class="titled-gallery-caption"><a href="#">Boca Chica</a></div>
          </div>
    ...
    <section class="section section-xs text-center bg-gray-700 novi-background bg-cover">
      <div class="container container-wide">
        <div class="box-cta-thin">
          <p class="big"><strong>Los precios más asequibles! </strong>&nbsp;<span>Elige tu destino favorito!</span></p>
        </div>
      </div>
    </section>
