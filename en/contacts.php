            ...
            <div class="row row-fix row-50 row-custom-bordered">
                <div class="col-sm-6 col-lg-3">
                    ...
                    <article class="box-simple">
                        ...
                        <h6>Address</h6>
                        <div class="box-simple-text"><a href="#">Libertad Street #3, La Caleta</a></div>
                    </article>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <!-- Box simple-->
                ...
                <div class="row row-fix row-50">
                    <div class="col-lg-8 col-xl-7">
                        <div class="section-wrap-content section-lg">
                            ...
                            <p class="big">You can contact us in any way that is convenient for you. We are available 24/7 via email. You can also use the quick contact form below or visit our office personally.</p>
                            <!-- RD Mailform-->
                            <form class="rd-mailform" id="contactForm">
                                <div class="row row-fix row-20">
                                    <div class="col-md-6">
                                        <div class="form-wrap form-wrap-validation">
                                            <label class="form-label-outside" for="name">First Name</label>
                                            <input type="text" class="form-input" id="name" name="name" placeholder="Enter your first name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-wrap form-wrap-validation">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-wrap form-wrap-validation">
                                            <label class="form-label-outside" for="subject">Subject</label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-wrap form-wrap-validation">
                                            ...
                                            <textarea class="form-input" name="message" id="message" rows="1" placeholder="Enter your message" required></textarea>
                                        </div>
                                    </div>
